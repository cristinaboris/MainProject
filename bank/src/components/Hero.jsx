...
<div className="flex flex-row justify-between items-center w-full text-white ss:leadibg-[100px] leadibg-[75px]">

    <h1 className='flex-1 font-poppings font-semibold ss:text-[72px] text-[52px]'>The Next <br className='sm:block hidden'/> {''}
